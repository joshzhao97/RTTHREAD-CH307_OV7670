...
#define SCCB_SIC_H()      GPIO_SetBits(SCCB_GPIO,GPIO_Pin_10) //对端口A特定位的设置  ,这里设置高
#define SCCB_SIC_L()      GPIO_ResetBits(SCCB_GPIO,GPIO_Pin_10)//这里设置低

#define SCCB_SID_H()      GPIO_SetBits(SCCB_GPIO,GPIO_Pin_11)//同上
#define SCCB_SID_L()      GPIO_ResetBits(SCCB_GPIO,GPIO_Pin_11)
/**/
